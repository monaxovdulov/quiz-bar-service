...
Используй текст ниже как вдохновение, чтобы придумать 10 оригинальных и забавных барных вопросов в стиле "Would You Rather" для квиза. Для каждого вопроса добавь краткий ответ, факт или шутку, который подойдёт как правильный вариант.

Правила для каждого вопроса:
1. Длина не превышает 100 символов.
...
Внутри data должно быть ровно 10 элементов. Верни только валидный JSON без Markdown и пояснений.
